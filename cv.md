...
[Sorry for my bad England xD] (https://www.youtube.com/watch?v=_y5z3TzW3k0)
...
minn = arr[0][0] + arr[0][1]
for i in range(1, n):
    if arr[i][0] + arr[i][1] <= minn:
        minn = arr[i][0] + arr[i][1]
